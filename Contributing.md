...
* Relatar bugs de documentação [com Problemas do GitHub.](https://github.com/OfficeDev/office-scripts-docs/issues)
* Solicitar nova documentação [com Problemas do GitHub.](https://github.com/OfficeDev/office-scripts-docs/issues)
...
Por exemplo, se sua filial local X foi mesclada com êxito na ramificação mestra OfficeDev/office-scripts-docs e você deseja fazer atualizações adicionais para o conteúdo mesclado. Crie uma nova filial local, X2, a partir da filial mestra OfficeDev/office-scripts-docs. Para fazer isso, abra o GitBash e execute os seguintes comandos:
