...
* Relatar bugs de documentação [com GitHub Problemas](https://github.com/OfficeDev/office-scripts-docs/issues).
* Solicitar nova documentação com [GitHub Problemas](https://github.com/OfficeDev/office-scripts-docs/issues).
