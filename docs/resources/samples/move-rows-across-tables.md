...
Há dois scripts nesta solução. A principal diferença é como as linhas são selecionadas.
...
## <a name="sample-code-move-rows-using-table-filter"></a>Código de exemplo: Mover linhas usando filtro de tabela
