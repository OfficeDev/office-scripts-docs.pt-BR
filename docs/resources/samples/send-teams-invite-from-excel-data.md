...
<span data-ttu-id="fcbc0-112">A solução tem 3 partes:</span><span class="sxs-lookup"><span data-stu-id="fcbc0-112">The solution has 3 parts:</span></span>
