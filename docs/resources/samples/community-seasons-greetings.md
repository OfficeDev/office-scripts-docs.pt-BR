...
---
# <a name="seasons-greetings"></a>Saudações de estações

Este script foi contribuído [por Leslie Black](https://www.linkedin.com/in/lesblackconsultant/) no espírito da estação de feriado! É um script divertido que mostra uma árvore de Natal cantoria no Excel na Web usando Scripts do Office.
